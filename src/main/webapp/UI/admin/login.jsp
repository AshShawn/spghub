...
<body>
	...
	<div id="login">
		...
		<div class="loginAction">
			<div id="form">
				<span id="span1">管理员登录</span><span id="language">Language:简体中文</span>
				<form class="layui-form layui-form-pane" action="${path }/admin/adminLogin.form" method="post">
					...
					<!-- <a id="forget">忘记密码</a><a id="register">点击注册</a> -->
