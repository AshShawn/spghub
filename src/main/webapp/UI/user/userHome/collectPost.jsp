			...
			<div class="left">
				...
				<div class="layui-tab">
					<ul class="layui-tab-title" style="margin-left: 10px;">
						...
						<li class="layui-this" lay-id="33"><a
			...
			laypage({
				...
				jump : function(obj, first) {
					if (!first) {
						...
						$("#showCollection").load(
								"${path }/user/UHcollectPostPage.form?pageNow="
										+ obj.curr);
