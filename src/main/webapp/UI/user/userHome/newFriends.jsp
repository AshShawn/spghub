			...
			<div class="left">
				...
				<div class="layui-tab">
					<ul class="layui-tab-title" style="margin-left: 10px;">
						<li lay-id="11"><a
							href="${pageContext.request.contextPath }/user/userHomeReply.form">回复我的</a></li>
						<li lay-id="22"><a
							href="${pageContext.request.contextPath }/user/userHomeFocus.form">我关注的</a></li>
						<li lay-id="33"><a
							href="${pageContext.request.contextPath }/user/UHcollectPost.form">收藏的帖子</a></li>
						<li class="layui-this" lay-id="44"><a
							href="${pageContext.request.contextPath }/user/UHFriends.form">关注我的</a></li>
					</ul>
								...
								<c:forEach var="a" items="${meUsers }">
									<div class="fans">
										...
										<div class="fansMessage">
											<span class="username">${a.focusUser.username }:</span> <span>关注了您</span>
										</div>
										<a class="have_a_look"
											href="${path }/user/userDisplay.form?id=${a.focusUser.id }"
			...
			laypage({
				...
				jump : function(obj, first) {
					if (!first) {
						...
						$("#showFriends").load(
								"${path }/user/UHFriendsPage.form?pageNow="
										+ obj.curr);
